...
One firmware includes four dashboard themes with the same live GT7 telemetry features:
...
- Select and save the Classic, GT3, Retro, or Radar dashboard theme.
...
GT3 is used when no theme has been saved. Classic, GT3, Retro and Radar expose the same supported telemetry; only their presentation differs.
